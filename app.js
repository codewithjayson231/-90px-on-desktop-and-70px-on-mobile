...
function handleRoute() {
    ...
    if (hash.startsWith('#/admin/' + ADMIN_SECRET_PATH)) {
        ...
        if (hash === '#/articles') {
            ...
            if (state.selectedArticle) trackVisit(id);
        } else {
...
function renderArticlesPage() {
    ...
    html += '</div><input type="text" class="search-input" placeholder="Search articles..." value="' + state.searchQuery + '" oninput="handleSearch(this.value)"></div><div class="articles-grid">';
